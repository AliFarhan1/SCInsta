...
+ (NSArray *)sections {
    return @[
        @{
            @"header": @"",
            @"rows": @[
                [SCISetting linkCellWithTitle:@"Donate"
                                     subtitle:@"Consider donating to support this tweak's development!"
                                         icon:[SCISymbol symbolWithName:@"heart.circle.fill"
        ...
        @{
            ...
            @"rows": @[
                [SCISetting navigationCellWithTitle:@"General"
                                           subtitle:@""
                                               icon:[SCISymbol symbolWithName:@"gearshape.fill"
                ...
                [SCISetting navigationCellWithTitle:@"Feed"
                                           subtitle:@""
                                               icon:[SCISymbol symbolWithName:@"house.fill"
                ...
                [SCISetting navigationCellWithTitle:@"Reels"
                                           subtitle:@""
                                               icon:[SCISymbol symbolWithName:@"play.rectangle.fill"
                                                                        color:[UIColor systemPinkColor]
                                                                         size:20.0]
                                        navSections:@[
                    @{
                ...
                [SCISetting navigationCellWithTitle:@"Navigation"
                                           subtitle:@""
                                               icon:[SCISymbol symbolWithName:@"squares.leading.rectangle.fill"
                ...
                [SCISetting navigationCellWithTitle:@"Confirm actions"
                                           subtitle:@""
                                               icon:[SCISymbol symbolWithName:@"checkmark.shield.fill"
        ...
        @{
            ...
            @"rows": @[
                [SCISetting navigationCellWithTitle:@"Debug"
                                           subtitle:@""
                                               icon:[SCISymbol symbolWithName:@"ladybug.fill"
                    ...
                    @{
                        ...
                        @"rows": @[
                            ...
                            [SCISetting buttonCellWithTitle:@"Reset onboarding completion state"
                                                   subtitle:@""
                                                       icon:[SCISymbol symbolWithName:@"arrow.counterclockwise.circle.fill"
                                                                                color:[UIColor systemOrangeColor]
                                                                                 size:20.0]
                                                     action:^(void) {
